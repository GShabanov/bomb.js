...
(function () {
    ...
    var height = 13;
    //
    // gameplay field size in pixels
    //
    var canvasWidth = (width - 1) * 40;
    var canvasHeight = (height - 1) * 40;
    ...
    function step() {
        ...
        drawCorner(20, 40, 0);
        drawCorner(canvasWidth + 20, 40, Math.PI * 0.5);
        drawCorner(canvasWidth + 20, canvasHeight + 40, Math.PI);
        drawCorner(20, canvasHeight + 40, Math.PI * 1.5);
                        ...
                        if (field[coordX][coordY] != null)
                        {
                            ...
                            else if (field[coordX][coordY] instanceof SpriteField)
                            {
                                ...
                                if (sprite instanceof Bomb) {
                                    ...
                                    // only if it is not exploded before
                                    //
    ...
    function handleUpgrade(sprite, player) {
        ...
        if (sprite.draw == drawBombUpgrade) {
            ...
            //Increase size of explosion up to 7
            if (player.explosionSize < 7) {
                player.explosionSize++;
            }
        } else if (sprite.draw == drawSkatesUpgrade) {

            // 
            // Speed up player, it can boosted several times
            //
            if (player.moveTime > 350)
                player.moveTime = 350;
            else if (player.moveTime > 300)
                player.moveTime = 300;
            else if (player.moveTime > 250)
                player.moveTime = 250;
    ...
    function initBombJs()
    {
        ...
        //Clear canvas
        rect(20, 40, canvasWidth + 40, canvasHeight + 40, background);
        ...
        if (gameMode != Mode.MULTI_VERSUS)
        {
            ...
            {
                var width5 = width - 3;
                var height5 = height - 3;
                var i = parseInt(Math.random() * width5) + 1;
                var j = parseInt(Math.random() * height5) + 1;
